...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .perks { margin-top: 36px; display: flex; flex-direction: column; gap: 14px; }
        .perk  { display: flex; align-items: center; gap: 12px; color: rgba(255,255,255,.85); font-size: 13px; }
        .perk-icon {
        ...
        .left-foot { font-size: 11px; color: rgba(255,255,255,.35); position: relative; }

        /* ── Right panel ── */
        .right { background: #fff; padding: 52px 48px; }
        .right h2 { font-family: 'Sora', sans-serif; font-size: 22px; font-weight: 600; color: #1F2A44; margin-bottom: 4px; }
        .right .sub { font-size: 13px; color: #aaa; margin-bottom: 36px; }
        ...
        .fld select.is-invalid { border-color: #D92BBF; }
        ...
        .upload-label:hover { border-color: #6A2FE0; background: #f5f0ff; }
        .upload-label input { display: none; }
        .upload-label .up-icon { font-size: 26px; margin-bottom: 8px; color: #c8b8f5; }
        .upload-label strong { font-size: 13px; color: #555; display: block; }
        .upload-label small  { font-size: 12px; color: #bbb; }
        #file-name { font-size: 12px; color: #6A2FE0; margin-top: 6px; font-weight: 500; }
        ...
        .notice { font-size: 11px; color: #ccc; text-align: center; margin-top: 14px; }

        /* alerts */
        .alert { padding: 13px 18px; border-radius: 10px; font-size: 13.5px; margin-bottom: 24px; }
        .alert-success { background: #eef9ee; color: #276827; border: 1px solid #b3e0b3; }
        .alert-error   { background: #fff0f8; color: #a3155a; border: 1px solid #f5b8d8; }
        ...
        <div class="left-mid">
            ...
            <div class="perks">
                @foreach($company['perks'] as $perk)
                    <div class="perk"><div class="perk-icon">✓</div>{{ $perk }}</div>
                @endforeach
            </div>
        </div>
        <div class="left-foot">{{ $company['website'] }}</div>
    </div>
